...
- API kulcsok (Whop, Odds API, PandaScore) CSAK a backenden — a frontend mindent a backend proxy-n át kér.
...
| `backend/src/routes/payments.rs` | Whop checkout + webhook (előfizetés aktiválás/lejárat) |
